...
emp1=Employee(1,"Alok",4000,"Data Analyst",{'a':50,'b':30})
emp2=Employee(2,"Aman",3000,"Business Analyst",{'a':40})
emp3=Employee(3,"Varun",5000,"System Engineer",{'a':30,'c':40})
emp4=Employee(4,"Sahil",2500,"Developer",{'b':45,'c':60})
